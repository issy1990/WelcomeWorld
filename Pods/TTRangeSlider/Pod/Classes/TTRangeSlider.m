...
//        self.leftHandle.backgroundColor = color;
   //     self.rightHandle.backgroundColor = color;
        self.leftHandle.backgroundColor = (__bridge CGColorRef _Nullable)([UIColor clearColor]);
        self.rightHandle.backgroundColor = (__bridge CGColorRef _Nullable)([UIColor clearColor]);
