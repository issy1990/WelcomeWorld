...
- (void)viewDidLoad
{
    ...
    self.getStarted.layer.cornerRadius = self.getStarted.frame.size.height/2;
    self.getStarted.layer.masksToBounds = YES;
    self.getStarted.titleLabel.font = [UIFont fontWithName:@"SourceSansPro-Regular" size:15.0f];
